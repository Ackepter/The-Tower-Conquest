...
public partial class SEsc : Area2D
{
    private string startEscapeMessage = "Ты не можешь сбежать";
    ...
    private Map1Script _map;
    public override void _Ready()
    {
        _map = GetParent().GetParent() as Map1Script;
    }
