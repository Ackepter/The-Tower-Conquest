...
public partial class Map1Script : Node2D
{
    private string startEscapeMessage = "Бей Маникен!!!";
    ...
    public bool getIsEnded => isEnded;
    ...
    public override void _Ready()
    {
        ...
        _audioPlayer.Play();
        hero = GetNode<MainCharacter>("MainCharacter");
    ...
    public void ShowStartMessage()
    {
        if(isEnded){
            ...
            var timer2 = GetTree().CreateTimer(startEscapeMessage.Length * 0.1 + 2);
            timer2.Timeout += () => {
